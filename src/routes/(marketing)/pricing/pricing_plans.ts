...
export const pricingPlans = [
  {
    ...
    name: "Free",
    description:
      "Discuss your startup needs with us and explore the right plan.",
    price: "₹0",
  ...
  },
  {
    ...
    name: "Growth Plan",
    description:
      "Essential startup solutions for branding, marketing & lead generation.",
    price: "₹20,000",
  ...
  },
  {
    ...
    name: "Scale Plan",
    description:
      "Comprehensive growth execution with full marketing & sales support.",
    price: "₹50,000",
    priceIntervalName: "Monthly",
    features: [
      "All in  Growth plan",
