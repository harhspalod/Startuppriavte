...
>
  ...
  >
    <div class="px-6">
      <h1 class="text-2xl lg:text-4xl font-bold mb-4">Contact Startopia</h1>
      <p class="text-lg">Connect with our experts to:</p>
      <ul class="list-disc list-outside pl-6 py-4 space-y-1">
        <li class="">Get a personalized startup consultation</li>
        <li class="">Explore our services and solutions</li>
        <li>Receive a tailored pricing plan</li>
        <li>Resolve any technical or service inquiries</li>
      </ul>
      <p>Fill out the form, and our team will reach out to you shortly!</p>
      <p class="text-sm pt-8">
        *Response time may vary based on inquiry volume.
      </p>
    </div>
  </div>
            ...
            <label for={field.id}>
              ...
              {#if field.inputType === "textarea"}
                <textarea
                  ...
                  rows={4}
                  placeholder={field.id === "message"
                    ? "Enter your message with plan details"
                    : "Enter your " +
