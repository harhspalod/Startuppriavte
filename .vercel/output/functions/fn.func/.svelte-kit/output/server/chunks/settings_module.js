import { a1 as ensure_array_like, X as attr, $ as stringify, V as store_get, W as unsubscribe_stores, T as pop, Q as push } from "./index.js";
import "./client.js";
...
function Settings_module($$payload, $$props) {
  ...
  $$payload.out += `<div class="card p-6 pb-7 mt-8 max-w-xl flex flex-col md:flex-row shadow">`;
  if (title) {
    $$payload.out += "<!--[-->";
