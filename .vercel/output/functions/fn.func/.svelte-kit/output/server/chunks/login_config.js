import { a2 as sanitize_props, a3 as rest_props, Q as push, a4 as fallback, a5 as spread_attributes, Y as clsx, a6 as slot, a7 as bind_props, T as pop, a8 as copy_payload, a9 as assign_payload, a1 as ensure_array_like, X as attr } from "./index.js";
  ...
  $$payload.out += `<button${spread_attributes(
    {
      ...
      class: clsx(classNames.join(" ")) + " svelte-ll2s9h"
    },
    { "svelte-ll2s9h": true }
  )}><!---->`;
  slot($$payload, $$props, "default", {});
...
function Auth($$payload, $$props) {
  ...
  let $$inner_payload;
  function $$render_inner($$payload2) {
    $$payload2.out += `<div${attr("class", clsx(theme !== "default" ? themeVariables : ""))}>`;
    if (SignView) {
      $$payload2.out += "<!--[-->";
      SocialAuth($$payload2, {
        appearance,
